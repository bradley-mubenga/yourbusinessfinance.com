    ...
    <section id='about'>
        <div className='container'>
            <div className='aboutContent'>
                <h1 className='heading2'>IN THIS COURSE YOU WILL LEARN THINGS LIKE:</h1>
                <ul>
                    <li>1. HOW TO BUDGET AND PLAN OUT YOUR YEAR AND THEN USE THAT BUDGET TO MAKE FINANCIAL DECISIONS LIKE PAYING YOURSELF AND THE NEED FOR INVESTMENT.</li>
